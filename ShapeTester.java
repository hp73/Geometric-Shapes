/*
 * This is a tester for all the shape classes.
 * @author Harry Pinkerton and Laurie Jones
 * @version 1.0
 */
...
//testing equals()
      ...
      Square squareC = new Square(3,0,5, true, "WHITE");
      ...
      Triangle triangleC = new Triangle(3,3,0,5, true, "WHITE");
